...
- **Phase 2 / Phase 3 are drafted, not started** — `Automations/Tickets/phase-2-execution/` (16 tickets) covers multi-node chains, real Channel/Webview outbound send, retries, scheduler. `Automations/Tickets/phase-3-canvas/` (10 tickets) covers the visual canvas editor. Read STATE.md before picking up either.
