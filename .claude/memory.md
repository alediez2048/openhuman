...
- **Workflow initiative phases — drafted, ordering decided 2026-05-22 (Option B)** — `Automations/Tickets/phase-2-execution/` (16 tickets, multi-node chains + real Channel/Webview send + retries + scheduler tightening) is **the next priority** after Phase 1.5 polish landed. `Automations/Tickets/phase-3-browser-agent/` (overview + 7 sub-tickets, CEF-native CDP-driven browser agent with Stagehand-style act/extract/observe API) is **next after Phase 2**. `Automations/Tickets/phase-4-canvas/` (10 tickets, visual canvas editor) is **demand-gated** per `prd.md §5.3` and may never ship. **Browser Agent (Phase 3) does NOT depend on Canvas (Phase 4).** Browser-agent was originally numbered Phase 4 and Canvas was Phase 3; they were swapped 2026-05-22 to reflect actual implementation priority. Read STATE.md before picking up any phase.
