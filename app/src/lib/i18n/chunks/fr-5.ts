...
const fr5: TranslationMap = {
  ...
  // Campaigns (Phase 4 / F4-11). English fallbacks — translate later.
  'campaigns.new_cta': '+ New campaign',
  'campaigns.list_error': 'Could not load campaigns',
  'campaigns.list_retry': 'Retry',
  'campaigns.empty_title': 'No campaigns yet',
  'campaigns.empty_body':
    'Campaigns are long-running automations over a recordset — vendor outreach, content distribution, monitoring. Describe what you want OpenHuman to do and we’ll set one up.',
  'campaigns.empty_cta': 'Ask OpenHuman to build a campaign',
  'campaigns.search_placeholder': 'Search campaigns…',
  'campaigns.filter_label': 'Filter by status',
  ...
  'campaigns.no_results': 'No campaigns match your filter.',
  'campaigns.status.draft': 'Draft',
  'campaigns.status.active': 'Active',
  'campaigns.status.paused': 'Paused',
  'campaigns.status.wound_down': 'Winding down',
  'campaigns.status.archived': 'Archived',
  'campaigns.card.more_actions': 'More actions',
  'campaigns.card.view_detail': 'View detail',
  'campaigns.card.pause': 'Pause',
  'campaigns.card.resume': 'Resume',
