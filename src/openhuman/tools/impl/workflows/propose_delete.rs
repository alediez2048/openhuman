...
impl Tool for WorkflowProposeDeleteTool {
    ...
    async fn execute(&self, args: Value) -> anyhow::Result<ToolResult> {
        ...
        let preview_tag =
            format!("<workflow-preview kind=\"delete\" data=\"{data_b64}\"></workflow-preview>");
        let payload = json!({
        ...
        let markdown = format!(
            "Delete preview ready. Include this tag verbatim in your reply, then stop — do NOT call this tool again.\n\n{preview_tag}"
        );
