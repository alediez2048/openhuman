...
///   - Moonshot's Kimi K2 family which only accepts `temperature: 1`
///     (#2076 — 146 Sentry events from users in China hitting
///     *"invalid temperature: only 1 is allowed for this model"*
///     on `kimi-k2.6`). Also matches OpenRouter / third-party
///     `moonshot/...` / `moonshotai/...` namespacings.
