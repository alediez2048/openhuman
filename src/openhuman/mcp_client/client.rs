...
/// MCP Streamable HTTP spec requires clients to advertise both response
/// shapes — the server picks one per request. Strict servers (Higgsfield,
/// the official @modelcontextprotocol SDK) return 406 Not Acceptable
/// without this header.
