...
mod tests {
    ...
    fn all_builtins_parse() {
        ...
        // Upstream's count + our `workflow_node` addition. If upstream
        // adds another agent, bump this number after re-running the
        // suite locally. The BUILTINS.len() check above is the strict
        // anti-drift gate; this is the human-readable cross-check.
        assert_eq!(defs.len(), 19, "expected 19 built-in agents");
    }
